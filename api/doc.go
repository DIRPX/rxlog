...
// Package api defines the public, implementation-neutral contracts for the
// rxlog logging stack.
//
...
// # Design goals
//
// The api namespace is organized around a few core principles:
//
//   - Clear separation of API and implementation: the api module defines
...
// # Subpackages
//
// The api namespace is split into subpackages, each responsible for a
...
//
// The api module deliberately does not provide concrete encoders, cores,
...
//     hooks, and error handlers on top of api abstractions; and
//
